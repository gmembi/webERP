...
if (isset($_POST['ProcessSale']) AND $_POST['ProcessSale'] != '') {
	...
	// *************************************************************************
		...
		if ($_SESSION['InvoicePortraitFormat']==0) {
            ...
            echo '<meta http-equiv="Refresh" content="0; url=' . $RootPath.'/PDFCounterSales.php?BatchNo=' . $ReceiptNumber . '&amp;InvNo=' . $InvoiceNo . '&amp;InvOrCredit=Invoice&amp;PrintPDF=True" />';
		...
		// '<a href="' . $rootpath . '/PDFCounterReceipt.php?ReceiptNo=' . $ReceiptNumber . '&InvoiceNo='. $InvoiceNo .'&OrderNo='. $OrderNo .'">' . _('Print Receipt') . '</a></p>';
