...
if ((!isset($_POST['PeriodFrom']) or !isset($_POST['PeriodTo'])) or $NewReport == 'on') {
	...
	$SQL="SELECT accountname FROM chartmaster WHERE accountcode='".$SelectedAccount  . "'";
	$result=DB_query($SQL);
	$MyRow=DB_fetch_row($result);
	//$GraphTitle = _('GL Account Graph - Actual vs. Budget') . "\n\r";
	$GraphTitle .= _('GL Account Graph - Actual vs. Budget for ')  . $MyRow[0] . "\n\r";
	...
	$Graph->SetDataColors(array('YellowGreen', 'brown'), //Data Colors
