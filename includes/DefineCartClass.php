...
Class Cart {
	...
	function update_cart_item( $UpdateLineNumber,
		...
		$this->LineItems[$UpdateLineNumber]->LGroup = $LGroup;
		$this->LineItems[$UpdateLineNumber]->LSection = $LSection;
		$this->LineItems[$UpdateLineNumber]->LCost = $LCost;
		$this->LineItems[$UpdateLineNumber]->Source = $Source;
		if ($UpdateDB=='Yes'){
...
/* Constructor function to add a new LineDetail object with passed params */
		...
		$this->LGroup = $_POST['LGroup'];
		$this->LSection = $_POST['LSection'];
		$this->LCost = $_POST['LCost'];
