...
Class Journal {
	...
	function Add_To_GLAnalysis($Amount, $Narrative, $GLCode, $GLActName, $LGroup, $LSection, $LCost, $source, $assetid=1){
		if (isset($GLCode) AND $Amount!=0){
			$this->GLEntries[$this->GLItemID] = new JournalGLAnalysis($Amount, $Narrative, $this->GLItemID, $GLCode, $GLActName, $LGroup, $LSection, $LCost, $source, $assetid);
			$this->GLItemCounter++;
			$this->GLItemID++;
...
Class JournalGLAnalysis {
	...
	function __construct ($Amt, $Narr, $id, $GLCode, $GLActName, $LGroup, $LSection, $LCost, $source, $assetid){
...
/* Constructor function to add a new JournalGLAnalysis object with passed params */
	...
	function JournalGLAnalysis($Amt, $Narr, $id, $GLCode, $GLActName, $LGroup, $LSection, $LCost, $source, $assetid){
		self::__construct($Amt, $Narr, $id, $GLCode, $GLActName, $LGroup, $LSection, $LCost, $source, $assetid);
