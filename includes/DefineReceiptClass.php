...
Class Receipt_Batch {
	...
	function add_to_batch($Amount, $Customer, $Discount, $Narrative, $GLCode, $PayeeBankDetail, $CustomerName, $LGroup, $LSection, $LCost, $source){
		if ((isset($Customer) OR isset($GLCode)) AND ($Amount + $Discount) !=0){
			$this->Items[$this->ItemCounter] = new Receipt($Amount, $Customer, $Discount, $Narrative, $this->ItemCounter, $GLCode, $PayeeBankDetail, $CustomerName, $LGroup, $LSection, $LCost, $source);
			$this->ItemCounter++;
...
Class Receipt {
	...
	function __construct ($Amt, $Cust, $Disc, $Narr, $id, $GLCode, $PayeeBankDetail, $CustomerName, $LGroup, $LSection, $LCost, $source){
/* Constructor function to add a new Receipt object with passed params */
	...
	function Receipt($Amt, $Cust, $Disc, $Narr, $id, $GLCode, $PayeeBankDetail, $CustomerName, $LGroup, $LSection, $LCost, $source){
		self::__construct($Amt, $Cust, $Disc, $Narr, $id, $GLCode, $PayeeBankDetail, $CustomerName, $LGroup, $LSection, $LCost, $source);
	}
}
