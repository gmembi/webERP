...
$ModuleLink = array('Sales', 'AR', 'PO', 'AP', 'stock', 'manuf', 'GL', 'PR', 'FA', 'PC', 'system', 'Utilities');
$ReportList = array('Sales' => 'ord', 'AR' => 'ar', 'PO' => 'prch', 'AP' => 'ap', 'stock' => 'inv', 'manuf' => 'man', 'GL' => 'gl', 'PR' => 'pr', 'FA' => 'fa', 'PC' => 'pc', 'system' => 'sys', 'Utilities' => 'utils');
...
$ModuleList = array(_('Sales'), _('Receivables'), _('Purchases'), _('Payables'), _('Inventory'), _('Manufacturing'), _('General Ledger'), _('Payment Request'), _('Asset Manager'), _('Petty Cash'), _('Setup'), _('Utilities'));
...
_('Inventory Adjustments'), _('Inventory Issue'), _('Reverse Goods Received'), _('Enter Stock Counts'), _('Create a New Internal Stock Request'), _('Authorise Internal Stock Requests'), _('Fulfill Internal Stock Requests'));
$MenuItems['stock']['Transactions']['URL'] = array('/PO_SelectOSPurchOrder.php', '/StockTransfers.php?New=Yes', '/StockLocTransfer.php', '/StockLocTransferReceive.php', '/StockAdjustments.php?NewAdjustment=Yes', '/StockIssues.php', '/ReverseGRN.php', '/StockCounts.php', '/InternalStockRequest.php?New=Yes', '/InternalStockRequestAuthorisation.php', '/InternalStockRequestFulfill.php');
...
$MenuItems['manuf']['Transactions']['Caption'] = array(_('Work Order Entry'), _('Select A Work Order'), _('QA Samples and Test Results'), _('Timesheet Entry'));
...
$MenuItems['manuf']['Maintenance']['Caption'] = array(_('Work Centre'), _('Bills Of Material'), _('Copy a Bill Of Materials Between Items'), _('Master Schedule'), _('Auto Create Master Schedule'), _('MRP Calculation'), _('Quality Tests Maintenance'), _('Product Specifications'), _('Employees'));
...
$MenuItems['GL']['Reports']['Caption'] = array(_('Bank Account Balances'), _('Bank Account Reconciliation Statement'), _('Cheque Payments Listing'), _('Daily Bank Transactions'), _('Account Inquiry'), _('Graph of Account Transactions'), _('Account Listing'), _('Account Listing to CSV File'), _('General Ledger Journal Inquiry'), _('Trial Balance'), _('Balance Sheet'), _('Profit and Loss Statement'), _('Location Profit and Loss Statement'), _('Source of Funds Profit and Loss Statement'), _('Statement of Cash Flows'), _('Financial Statements'), _('Horizontal Analysis of Statement of Financial Position'), _('Horizontal Analysis of Statement of Comprehensive Income'), _('Tag Reports'), _('Tax Reports'));
$MenuItems['GL']['Reports']['URL'] = array('/BankAccountBalances.php', '/BankReconciliation.php', '/PDFChequeListing.php', '/DailyBankTransactions.php', '/SelectGLAccount.php', '/GLAccountGraph.php', '/GLAccountReport.php', '/GLAccountCSV.php', '/GLJournalInquiry.php', '/GLTrialBalance.php', '/GLBalanceSheet.php', '/GLProfit_Loss.php', '/LocationProfit_Loss.php', '/GLSourceProfit_Loss.php', '/GLCashFlowsIndirect.php', '/GLStatements.php', '/AnalysisHorizontalPosition.php', '/AnalysisHorizontalIncome.php', '/GLTagProfit_Loss.php', '/Tax.php');

$MenuItems['GL']['Maintenance']['Caption'] = array(_('Account Sections'), _('Account Groups'), _('GL Accounts'), _('GL Account Authorised Users'), _('User Authorised GL Accounts'), _('GL Budgets'), _('GL Location Group'), _('GL Location Section'), _('GL Location Cost'), _('GL Source of Funds'), _('GL Tags'), _('Bank Accounts'), _('Bank Account Authorised Users'), _('User Authorised Bank Accounts'), _('Maintain Journal Templates'));
$MenuItems['GL']['Maintenance']['URL'] = array('/AccountSections.php', '/AccountGroups.php', '/GLAccounts.php', '/GLAccountUsers.php', '/UserGLAccounts.php', '/GLBudgets.php', '/GLLocationGroup.php', '/GLLocationSection.php', '/GLLocationCost.php', '/GLSource.php', '/GLTags.php', '/BankAccounts.php', '/BankAccountUsers.php', '/UserBankAccounts.php', '/GLJournalTemplates.php');

$MenuItems['PR']['Transactions']['Caption'] = array(_('Payments Request Entry'), _('Payment Request'), _('Payment Request to Authorise'));
$MenuItems['PR']['Transactions']['URL'] = array('/GLPaymentRequest.php', '/PR_SelectOSPayRequest.php', '/PR_AuthoriseMyPayment.php');

$MenuItems['PR']['Reports']['Caption'] = array();
$MenuItems['PR']['Reports']['URL'] = array();

$MenuItems['PR']['Maintenance']['Caption'] = array();
$MenuItems['PR']['Maintenance']['URL'] = array();
