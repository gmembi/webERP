...
UPDATE `purchdata` SET `effectivefrom`=NOW() WHERE `effectivefrom`='1000-01-01';
ALTER TABLE `purchdata` DROP PRIMARY KEY;
ALTER TABLE `purchdata` ADD PRIMARY KEY (`supplierno`,`stockid`, `effectivefrom`); 
ALTER TABLE `salesorders` ADD `quotedate` date NOT NULL default '1000-01-01';
ALTER TABLE `salesorders` ADD `confirmeddate` date NOT NULL default '1000-01-01';
...
ALTER TABLE `purchorders` ADD `revised` date NOT NULL default '1000-01-01';
...
ALTER TABLE `purchorders` ADD `deliverydate` date NOT NULL default '1000-01-01';
